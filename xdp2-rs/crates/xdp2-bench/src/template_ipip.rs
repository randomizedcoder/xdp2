...
pub(crate) fn extract_ipip_tcp(pkt: &[u8], meta: &mut FlowMeta) -> Result<(), ()> {
    ...
    meta.l2_off = 0;
    meta.l3_off = IPIP_INNER as u16;
    meta.l4_off = (IPIP_INNER + 20) as u16;
...
pub(crate) fn extract_vlan_ipip_tcp(pkt: &[u8], meta: &mut FlowMeta) -> Result<(), ()> {
    ...
    meta.l2_off = 0;
    meta.l3_off = VLAN_IPIP_INNER as u16;
    meta.l4_off = (VLAN_IPIP_INNER + 20) as u16;
...
pub(crate) fn extract_qinq_ipip_tcp(pkt: &[u8], meta: &mut FlowMeta) -> Result<(), ()> {
    ...
    meta.l2_off = 0;
    meta.l3_off = QINQ_IPIP_INNER as u16;
    meta.l4_off = (QINQ_IPIP_INNER + 20) as u16;
