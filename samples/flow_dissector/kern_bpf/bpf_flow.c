...
//
// Vendored from Linux kernel selftests:
//   tools/testing/selftests/bpf/progs/bpf_flow.c
//
// BPF flow dissector program. Loaded as BPF_PROG_TYPE_FLOW_DISSECTOR
// and exercised via BPF_PROG_TEST_RUN for benchmarking.
//
// This is the kernel's reference BPF flow dissector implementation.
// It uses tail calls via a jmp_table prog_array map with 6 sub-programs:
