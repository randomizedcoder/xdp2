...
| **D. Production eBPF (`xdp2-flow-ebpf`)** | Fast-path + tail-call array + slow-path fallback + loader + Nix packaging | 🔵 in progress (D1–D5 ✅ minus §5a, D6a ✅, D7 ✅, D8 ✅) | D6 (full slow-path) awaits xdp2-compiler `.o`; D9 CO-RE next |
