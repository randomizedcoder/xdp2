...
- [ ] **D7.** Userspace loader `xdp2-flow-loader` (Rust).
  ...
  - [ ] **D7b** — libbpf-backed implementation of `Loader::load` (open .o, populate `jmp_table`) and `Loader::attach` (flow_dissector hook), mirroring `samples/flow_dissector/fast_bpf/parity_test.c:42-100`.
