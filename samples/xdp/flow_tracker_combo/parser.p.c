...
static inline __unused() __attribute__((always_inline)) int
	xdp2_parser_simple_tuple_xdp2_encap_layer(
...
static inline __unused() int
	__xdp2_parser_simple_tuple_ether_node_xdp2_parse(
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_tuple_ip_check_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_tuple_ipv4_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_tuple_ipv6_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_tuple_ports_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	switch (type) {
	case 0x8:
		return __xdp2_parser_simple_tuple_ip_check_node_xdp2_parse(
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	switch (type) {
	case 0x4:
		return __xdp2_parser_simple_tuple_ipv4_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	case 0x6:
		return __xdp2_parser_simple_tuple_ipv6_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	}
	return parse_node->unknown_ret;
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	switch (type) {
	case 0x6:
		return __xdp2_parser_simple_tuple_ports_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	case 0x11:
		return __xdp2_parser_simple_tuple_ports_node_xdp2_parse(
		...
		unsigned int flags)
{
	...
	(void)&__xdp2_parser_simple_tuple_ether_node_xdp2_parse;
	(void)&__xdp2_parser_simple_tuple_ip_check_node_xdp2_parse;
	(void)&__xdp2_parser_simple_tuple_ipv4_node_xdp2_parse;
	(void)&__xdp2_parser_simple_tuple_ipv6_node_xdp2_parse;
	(void)&__xdp2_parser_simple_tuple_ports_node_xdp2_parse;

	ret = __xdp2_parser_simple_tuple_ether_node_xdp2_parse(
