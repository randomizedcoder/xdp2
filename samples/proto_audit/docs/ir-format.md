...
proto-audit normalizes protocol definitions from all nine sources (XDP2,
Linux kernel, Scapy, tshark, etherparse, libpcap, Kaitai Struct, Suricata, OMI) into a common IR defined
