...
pub struct ProtocolNames {
    ...
    /// etherparse source file (relative to crate root, e.g., "etherparse/src/link/ethernet2_header.rs")
...
pub fn protocol_table() -> Vec<ProtocolNames> {
    vec![
        ...
        ProtocolNames {
            ...
            scapy: Some("Ether"),
            tshark: Some("eth"),
            etherparse_struct: Some("Ethernet2Header"),
            etherparse_file: Some("etherparse/src/link/ethernet2_header.rs"),
            min_header_bytes: 14,
        ...
        ProtocolNames {
            ...
            scapy: Some("Dot1Q"),
            tshark: Some("vlan"),
            etherparse_struct: Some("SingleVlanHeader"),
            etherparse_file: Some("etherparse/src/link/single_vlan_header.rs"),
            min_header_bytes: 4,
            variable_length: false,
        },
        ProtocolNames {
        ...
        ProtocolNames {
            ...
            scapy: Some("IP"),
            tshark: Some("ip"),
            etherparse_struct: Some("Ipv4Header"),
            etherparse_file: Some("etherparse/src/net/ipv4_header.rs"),
            min_header_bytes: 20,
        ...
        ProtocolNames {
            ...
            scapy: Some("IPv6"),
            tshark: Some("ipv6"),
            etherparse_struct: Some("Ipv6Header"),
            etherparse_file: Some("etherparse/src/net/ipv6_header.rs"),
            min_header_bytes: 40,
            variable_length: false,
        },
        ProtocolNames {
            ...
            scapy: Some("ARP"),
            tshark: Some("arp"),
            etherparse_struct: Some("ArpPacket"),
            etherparse_file: Some("etherparse/src/net/arp_packet.rs"),
            min_header_bytes: 8,
            variable_length: true,
        },
        ProtocolNames {
        ...
        ProtocolNames {
            ...
            scapy: Some("ICMP"),
            tshark: Some("icmp"),
            etherparse_struct: Some("Icmpv4Header"),
            etherparse_file: Some("etherparse/src/transport/icmpv4_header.rs"),
            min_header_bytes: 8,
            variable_length: false,
        },
        ProtocolNames {
            ...
            tshark: Some("icmpv6"),
            etherparse_struct: Some("Icmpv6Header"),
            etherparse_file: Some("etherparse/src/transport/icmpv6_header.rs"),
            min_header_bytes: 8,
            variable_length: false,
        },
        ProtocolNames {
        ...
        ProtocolNames {
            ...
            scapy: Some("TCP"),
            tshark: Some("tcp"),
            etherparse_struct: Some("TcpHeader"),
            etherparse_file: Some("etherparse/src/transport/tcp_header.rs"),
            min_header_bytes: 20,
            variable_length: true,
        },
        ProtocolNames {
            ...
            scapy: Some("UDP"),
            tshark: Some("udp"),
            etherparse_struct: Some("UdpHeader"),
            etherparse_file: Some("etherparse/src/transport/udp_header.rs"),
            min_header_bytes: 8,
            variable_length: false,
        },
        // ── Tunneling ──
        ...
        ProtocolNames {
            canonical: "IPv6_EH",
            xdp2: Some("xdp2_parse_ipv6_eh"),
            kernel_struct: Some("ipv6_opt_hdr"),
            kernel_header: Some("linux/ipv6.h"),
            scapy: Some("IPv6ExtHdrHopByHop"),
            tshark: Some("ipv6.hop"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 2,
            variable_length: true,
        ...
        ProtocolNames {
            canonical: "IPv6_ND",
            xdp2: Some("xdp2_parse_ipv6_nd"),
            kernel_struct: Some("nd_msg"),
            kernel_header: Some("linux/neighbour.h"),
            scapy: Some("ICMPv6ND_NS"),
            tshark: Some("icmpv6"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 24,
        ...
        // ── IEEE 802.15.4 ──
        ProtocolNames {
            canonical: "IEEE802154",
            xdp2: Some("xdp2_parse_ieee802154"),
            kernel_struct: Some("ieee802154_hdr_fc"),
            kernel_header: Some("linux/ieee802154.h"),
            scapy: Some("Dot15d4"),
            tshark: Some("wpan"),
            etherparse_struct: None,
            etherparse_file: None,
        ...
        ProtocolNames {
            canonical: "MCTP",
            xdp2: Some("xdp2_parse_mctp"),
            kernel_struct: Some("mctp_hdr"),
            kernel_header: Some("linux/mctp.h"),
            scapy: None,
            tshark: Some("mctp"),
            etherparse_struct: None,
            etherparse_file: None,
        ...
        ProtocolNames {
            canonical: "Phonet",
            xdp2: Some("xdp2_parse_phonet"),
            kernel_struct: Some("phonethdr"),
            kernel_header: Some("linux/phonet.h"),
            scapy: None,
            tshark: Some("phonet"),
            etherparse_struct: None,
            etherparse_file: None,
        ...
        // ── Generic Netlink ──
        ProtocolNames {
            canonical: "GenNetlink",
            xdp2: Some("xdp2_parse_genetlink"),
            kernel_struct: Some("genlmsghdr"),
            kernel_header: Some("linux/genetlink.h"),
            scapy: None,
            tshark: Some("genl"),
            etherparse_struct: None,
            etherparse_file: None,
        ...
        ProtocolNames {
            canonical: "NLAttr",
            xdp2: Some("xdp2_parse_nlattr"),
            kernel_struct: Some("nlattr"),
            kernel_header: Some("linux/netlink.h"),
            scapy: None,
            tshark: None,
            etherparse_struct: None,
        ...
        ProtocolNames {
            canonical: "TIPC",
            xdp2: Some("xdp2_parse_tipc"),
            kernel_struct: Some("tipc_basic_hdr"),
            kernel_header: Some("linux/tipc.h"),
            scapy: None,
            tshark: Some("tipc"),
            etherparse_struct: None,
            etherparse_file: None,
        ...
        ProtocolNames {
            canonical: "HCI_CMD",
            xdp2: Some("xdp2_parse_hci_cmd"),
            kernel_struct: Some("hci_command_hdr"),
            kernel_header: Some("net/bluetooth/hci.h"),
            scapy: Some("HCI_Command_Hdr"),
            tshark: Some("bthci_cmd"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 3,
        ...
        ProtocolNames {
            canonical: "HCI_ACL",
            xdp2: Some("xdp2_parse_hci_acl"),
            kernel_struct: Some("hci_acl_hdr"),
            kernel_header: Some("net/bluetooth/hci.h"),
            scapy: Some("HCI_ACL_Hdr"),
            tshark: Some("bthci_acl"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 4,
            variable_length: false,
        ...
        ProtocolNames {
            canonical: "HCI_Event",
            xdp2: Some("xdp2_parse_hci_event"),
            kernel_struct: Some("hci_event_hdr"),
            kernel_header: Some("net/bluetooth/hci.h"),
            scapy: Some("HCI_Event_Hdr"),
            tshark: Some("bthci_evt"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 2,
            variable_length: false,
        ...
        ProtocolNames {
            canonical: "HCI_SCO",
            xdp2: Some("xdp2_parse_hci_sco"),
            kernel_struct: Some("hci_sco_hdr"),
            kernel_header: Some("net/bluetooth/hci.h"),
            scapy: Some("HCI_SCO_Hdr"),
            tshark: Some("bthci_sco"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 3,
            variable_length: false,
        ...
        ProtocolNames {
            canonical: "HCI_ISO",
            xdp2: Some("xdp2_parse_hci_iso"),
            kernel_struct: Some("hci_iso_hdr"),
            kernel_header: Some("net/bluetooth/hci.h"),
            scapy: None,
            tshark: Some("bthci_iso"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 4,
            variable_length: false,
        ...
        ProtocolNames {
            canonical: "MAC_Control",
            xdp2: Some("xdp2_parse_mac_control"),
            kernel_struct: None,
            kernel_header: None,
            scapy: None,
            tshark: Some("macc"),
        ...
        ProtocolNames {
            canonical: "Slow_Protocols",
            xdp2: Some("xdp2_parse_slow"),
            kernel_struct: None,
            kernel_header: None,
            scapy: None,
            tshark: Some("slow"),
        ...
        ProtocolNames {
            canonical: "IB_AtomicETH",
            xdp2: None,
            kernel_struct: None,
            kernel_header: None,
            scapy: None,
            tshark: Some("infiniband.atomiceth"),
            etherparse_struct: None,
            etherparse_file: None,
            min_header_bytes: 28,
            variable_length: false,
...
///
/// `source` must be one of: "xdp2", "kernel", "scapy", "tshark", "etherparse"
