//! CLI argument definitions for proto-audit.
//!
//! Contains the clap-derived `Cli`, `SourcePaths`, and `Commands` types.
//! Separated from `main.rs` to keep the entry point focused on dispatch.
