...
Supports 97 protocols from Ethernet through tunneling (GRE, VXLAN, Geneve,
...
RIP, ISIS, EIGRP), redundancy (VRRP, HSRP), UDP application protocols
...
| Command | Description |
|---|---|
| `list` | List all 97 known protocols |
...
- [x] IR core types and name mapping (97 protocols)
