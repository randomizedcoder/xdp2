...
#include "xdp2/compiler_helpers.h"
#include "parsers/parser_simple_hash.c"
...
static inline __unused() __attribute__((always_inline)) int
	xdp2_parser_simple_hash_ether_xdp2_encap_layer(
...
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ether_node_xdp2_parse(
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ipv4_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ipv4_check_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ipv6_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ipv6_check_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ipv6_eh_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ipv6_frag_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
...
/* Prototype for parse functions */
static inline __unused() int
	__xdp2_parser_simple_hash_ether_ports_node_xdp2_parse(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		void *metadata, void **frame, unsigned int frame_num,
		struct xdp2_ctrl_data *ctrl, unsigned int flags);
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	switch (type) {
	case 0x8:
		return __xdp2_parser_simple_hash_ether_ipv4_check_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	case 0xdd86:
		return __xdp2_parser_simple_hash_ether_ipv6_check_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	}
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	switch (type) {
	case 0x6:
		return __xdp2_parser_simple_hash_ether_ports_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	case 0x11:
		return __xdp2_parser_simple_hash_ether_ports_node_xdp2_parse(
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	return __xdp2_parser_simple_hash_ether_ipv4_node_xdp2_parse(
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	switch (type) {
	case 0x0:
		return __xdp2_parser_simple_hash_ether_ipv6_eh_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	case 0x2b:
		return __xdp2_parser_simple_hash_ether_ipv6_eh_node_xdp2_parse(
	...
	case 0x3c:
		return __xdp2_parser_simple_hash_ether_ipv6_eh_node_xdp2_parse(
			...
			ctrl, flags);
	case 0x2c:
		return __xdp2_parser_simple_hash_ether_ipv6_frag_node_xdp2_parse(
			parser, hdr, len, metadata, frame, frame_num,
			ctrl, flags);
	case 0x6:
		return __xdp2_parser_simple_hash_ether_ports_node_xdp2_parse(
		...
		struct xdp2_ctrl_data *ctrl, unsigned int flags)
{
	...
	return __xdp2_parser_simple_hash_ether_ipv6_node_xdp2_parse(
		parser, hdr, len, metadata, frame, frame_num, ctrl, flags);
}
...
{
	const struct xdp2_parse_node *parse_node =
		(const struct xdp2_parse_node*)&ipv6_eh_node;
	const struct xdp2_proto_def *proto_def = parse_node->proto_def;
	ssize_t hlen;
	int ret;
...
{
	const struct xdp2_parse_node *parse_node =
		(const struct xdp2_parse_node*)&ipv6_frag_node;
	const struct xdp2_proto_def *proto_def = parse_node->proto_def;
	ssize_t hlen;
	int ret;
...
static inline __unused() int
	xdp2_parser_simple_hash_ether_xdp2_parse_ether_node(
		const struct xdp2_parser *parser, void *hdr, size_t len,
		...
		unsigned int flags)
{
	...
	(void)&__xdp2_parser_simple_hash_ether_ether_node_xdp2_parse;
	(void)&__xdp2_parser_simple_hash_ether_ipv4_node_xdp2_parse;
	(void)&__xdp2_parser_simple_hash_ether_ipv4_check_node_xdp2_parse;
	(void)&__xdp2_parser_simple_hash_ether_ipv6_node_xdp2_parse;
	(void)&__xdp2_parser_simple_hash_ether_ipv6_check_node_xdp2_parse;
	(void)&__xdp2_parser_simple_hash_ether_ipv6_eh_node_xdp2_parse;
	(void)&__xdp2_parser_simple_hash_ether_ipv6_frag_node_xdp2_parse;
	(void)&__xdp2_parser_simple_hash_ether_ports_node_xdp2_parse;

	ret = __xdp2_parser_simple_hash_ether_ether_node_xdp2_parse(
...
XDP2_PARSER_OPT(
	xdp2_parser_simple_hash_ether_opt,
	"",
	ether_node,
	xdp2_parser_simple_hash_ether_xdp2_parse_ether_node,
	(
